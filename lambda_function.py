    ...
    if risk_level is not None:
        ...
        if risk_level not in risk_options:
            return build_validation_result(
                False,
                "risk_level",
                "Please type in a valid risk level: none, low, medium, or high.")
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        #Performs basic validation on the supplied input slots.
    ...
    #Return a message based on the user's risk tolerance.
    return close(
        intent_request["sessionAttributes"],
        "Fulfilled",
        {
            ...
            based on your stated risk tolerance of {}, we recommend the following
            portfolio: {}.
            """.format(
